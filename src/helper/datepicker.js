...
class DatePicker extends Component {
    ...
    getTitleElement() {
        ...
        if (!date && placeholder) {
            return (<Text style={[Style.placeholderText, customStyles.placeholderText, this.props.placeholderStyle]}>{placeholder}</Text>);
        }
        return (<Text style={[Style.dateText, customStyles.dateText, this.props.textStyle]}>{this.getDateStr()}</Text>);
    }
        ...
        return (
            ...
            >
                <View style={[Style.dateTouchBody, customStyles.dateTouchBody]}>
                    ...
                    {showIcon && <Image
                        style={[Style.dateIcon, customStyles.dateIcon,{tintColor: 'gray'}]}
                        source={iconSource}
                    />}
...
DatePicker.defaultProps = {
    ...
    confirmBtnText: '确定',
    cancelBtnText: '取消',
    iconSource: '',//require('./Resources/images/yuvi.jpg'),
    customStyles: {},
